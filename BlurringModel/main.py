...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder_path", default='disk2/jthe/datasets/BSD_1ms8ms/test/', type=str)
    parser.add_argument("--rsdm_results", default='home/jthe/DADeblur/RSDM/output/json/BSD_1ms8ms.json', type=str)
    parser.add_argument("--blur_condition_folder_path", default="home/jthe/DADeblur/DBCGM/output/BSD_1ms8ms/test/", type=str)
    parser.add_argument("--output_folder_path", default="home/jthe/DADeblur/BlurringModel/blurring_output/BSD_1ms8ms/test/", type=str)
