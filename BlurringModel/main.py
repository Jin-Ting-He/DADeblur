...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_folder_path", default='disk2/jthe/datasets/BSD_3ms24ms/test/', type=str)
    parser.add_argument("--rsdm_results", default='home/jthe/DADeblur/RSDM/output/json/BSD_3ms24ms.json', type=str)
